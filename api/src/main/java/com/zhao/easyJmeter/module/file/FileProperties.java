package com.zhao.easyJmeter.module.file;

import com.zhao.easyJmeter.common.factory.YamlPropertySourceFactory;
...
@PropertySource(
        value = "classpath:com/zhao/easyJmeter/extension/file/config.yml",
