package com.zhao.easyJmeter.common.aop;

import com.zhao.easyJmeter.common.configuration.CodeMessageConfiguration;
import com.zhao.easyJmeter.vo.UnifyResponseVO;
...
public class ResultAspect {
    @AfterReturning(returning = "result", pointcut = "execution(public * com.zhao.easyJmeter.controller..*.*(..))")
